...
<body>
	...
	<div style="background-color: white;">
		<div class="row m-0">
			...
			//Reply reply = ReplyDao.getReplyDao().replyno(m_no, v_no);
						...
						<div style="margin: 0 auto; height: 1000px;">
							<div class="mr=0" id=replylist style="overflow-y: auto; height: 700px;">
								...
								<div class="col-md-12 d-flex justify-content-start ml-1 mt-1 mr-0 row">
									<a href="../view/channel/newchannel.jsp" class="col-md-1 px-0"><img src="" class="col-md-12 p-0"
										style="width: 40px; height: 40px; border-radius: 50%;"></a>
									<div class="col-md-9 pl-2 mr-0">
										<a href="../view/channel/newchannel.jsp"> <span><%=temp.getR_no()%></span><%=temp.getC_name()%>
										</a>
									...
									<div class="col-md-2 mt-3 d-flex justify-content-between px-1 row" style="color: #656461; cursor: pointer;">
										<a onclick="replydelete(<%=temp.getR_no()%>);">삭제<%=temp.getR_no()%></a> <a onclick="replyupdate(<%=temp.getR_no()%>);">수정<%=temp.getR_no()%></a>
									</div>
									<div class="col-md-12 ml-4 row" id="updatereply" style="display: none;"></div>
									<%//} %>
								</div>
								<%
								}
						...
						<div class="col-md-12   pr-2 pd-2 pl-0 mt-3">
							<div class="row col-md-12 m-0 ">
								...
								<div class="col-md-2 pl-0 mb-4" style="border-radius: 15px;">
									<div>
										<a href="clipviewmain.jsp"> <img src="../img/land.jpg" <%//v_thumbnail %> class="recommendclips"
											style="border-radius: 15px; width: 100%;">
										</a>
									</div>
									<div class="col-md-12 mt-2 pl-0 pr-0">
										<h5><%=temp.getV_name()%></h5>
