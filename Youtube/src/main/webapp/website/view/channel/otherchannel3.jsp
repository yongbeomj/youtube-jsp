					...
					<div class="card">
						<div class="card-body">
							<div class="col-md-12  pr-2 pd-2 pl-0 mt-3" onscroll="c_no2(<%=c_no%>)">
									...
									<%
									for (int i = 0; i < channelboards.size(); i++) {
									%>
									...
									<div class="row">
										<div class="col-md-10">
											<div class="mt-2 ml-3 pr-0 d-flex justify-content-start" style="border:; border-radius: 5px;">
												...
												<a href="#"> <img src="../../upload/<%=member2.getM_image()%>" width="20" height="20" style="border-radius: 50%;">
									...
									<div class="d-flex pl-4 pr-2">
										<a href="clipviewmain.jsp"> <img src="../../upload/<%=channelboards.get(i).getCb_image()%>" class="recommendclips"
