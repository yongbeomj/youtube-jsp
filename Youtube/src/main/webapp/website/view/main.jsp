		...
		<div class="container col-md-9  offset-md-3 col-sm-10 offset-sm-2 col-xs-6 offset-xs-2 mt-2 ml-2">
			<div class="row justify-content-between ml-3">
				...
				<div class="card col-xs-8 offset-xs-2 m-2" style="width: 16rem;">
					<a href="clipviewmain.jsp?v_no=<%=v_no%>"> <img alt="" src="../upload/<%=videos.get(i).getV_thumbnail().split("_")[0]%>"
						class="card-img-top" style="max-width: 256px; max-height: 144px;">
					</a>
					...
					<div class="card-body row" style="height: 6rem;">
						<div class="col-md-2 pt-2 col-xs-2 col-sm-2" style="padding-left: 0; margin-left: 0">
							<a href="channel/otherchannel.jsp?c_no=<%=channel.getC_no()%>"> <img alt="" src="<%=channel.getC_image()%>"
								style="width: 2.5rem; height: 2.5rem; border-radius: 70%;">
							</a>
						</div>
						<div class="col-md-10 col-xs-10 col-sm-10">
							...
							%>
							<p class="card-text" style="font-size: 4px;">
								<a href="channel/otherchannel.jsp?c_no=<%=channel.getC_no()%>" style="text-decoration: none; color: black;"><%=channel.getC_name()%> ·
									<%=channel.getC_updatedate().split(" ")[0]%></a>
						</div>
					</div>
				</div>
				<%
